                ...
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-316cb649-6a3e-4ec3-9de8-7d83e880873f" id="dom-316cb649-6a3e-4ec3-9de8-7d83e880873f">
                    <form action="{{ route('posts.update', $post) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" id="exampleFormControlInput1" type="text" name="title" value="{{ $post->title }}" required />
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlTextarea1">Content</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="content" required>{{ $post->content }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput2">Date</label>
                            <input class="form-control" id="exampleFormControlInput2" type="date" name="date" value="{{ $post->date }}" required />
                        </div>
